...
class SimpleBrainClient:
    """Simple HTTP client for brain server communication."""
    ...
    def process_sensory_input(self, sensory_input):
        ...
        try:
            response = self.session.post(
                ...
                json={'sensory_input': sensory_input},
                timeout=5
            )
...
class TenMinuteValidator:
    ...
    def run_validation(self):
        ...
        if not self.client.connect():
            ...
            print("Please ensure server is running on port 8000")
            return
...
def main():
    ...
    print("Please ensure brain server is running on port 8000")
