...
def main():
    ...
    # Use the create function for proper initialization
    ...
    try:
        for cycle in range(100):  # 100 cycles
            ...
            sensory_input = np.random.randn(10) * 0.1  # Sensory input
            
            # Brain processes (field evolves)
            # PureFieldBrain.forward expects (sensory_input, reward)
            motor_output = brain.forward(sensory_input, reward=0.0)
