    ...
    def _execute_motors(self, motor_commands: Dict[str, float]):
        ...
        try:
            ...
            if abs(left) < 5 and abs(right) < 5:
                ...
                self.px.set_motor_speed(int(left), int(right))
            ...
            self.px.set_camera_servo1_angle(int(camera_pan))
            
            camera_tilt = motor_commands.get('camera_tilt_servo', 0)
            self.px.set_camera_servo2_angle(int(camera_tilt))
