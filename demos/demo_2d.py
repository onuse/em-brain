#!/usr/bin/env python3
"""
2D Demo - PiCar-X Top-Down Grid Visualization

Interactive 2D visualization for observing robot navigation and learning behaviors.
Perfect for debugging and understanding emergent navigation patterns.
...
Run with: python3 demo_runner.py 2d_demo
"""
